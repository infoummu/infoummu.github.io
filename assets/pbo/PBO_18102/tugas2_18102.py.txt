...
#fungsi input adalah sesuatu data yang kita masukan ke dalam program.
#berfungsi mengkonversi bilangan maupun string angka menjadi bilangan bulat (integer). 
# Fungsi int() menerima dua parameter, yaitu: x – bilangan yang akan diubah menjadi integer, defaultnya 0. base – basis bilangan, defaultnya adalah desimal (basis 10)
